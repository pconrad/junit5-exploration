...
public class MyTestExecutionListener implements TestExecutionListener {
    ...
    public void testPlanExecutionStarted(TestPlan testPlan) {
        System.out.println("testPlanExecutionStarted, testPlan=" + testPlan);
    }
    ...
    public void testPlanExecutionFinished(TestPlan testPlan) {
        System.out.println("testPlanExecutionFinished, testPlan=" + testPlan);
    }
    ...
    public void processForGradescope(
    ...
    public void executionFinished(TestIdentifier testIdentifier, TestExecutionResult testExecutionResult) {
        ...
        if (gradedTest != null) {
            processForGradescope(ms, testExecutionResult, gradedTest);
        }
